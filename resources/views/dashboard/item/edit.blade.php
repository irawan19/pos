						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<input class="form-control {{ General::validForm($errors->first('stock_items')) }} right-align" id="stock_items" type="numeric" name="stock_items" value="{{Request::old('stock_items') == '' ? $edit_items->stock_items : Request::old('stock_items')}}">
