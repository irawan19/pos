...
@section('content')
	...
	<div class="row">
		<div class="col-sm-6 col-center">
			<div class="card">
				<form class="form-horizontal m-t-40" action="{{ URL('dashboard/pembayaran/prosestambah') }}" method="POST">
					{{ csrf_field() }}
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<input class="form-control {{ General::validForm($errors->first('akun_pembayarans')) }}" id="akun_pembayarans" type="text" name="akun_pembayarans" value="{{Request::old('akun_pembayarans')}}">
						...
						<div class="form-group">
							...
							<input class="form-control {{ General::validForm($errors->first('no_rekening_pembayarans')) }}" id="no_rekening_pembayarans" type="text" name="no_rekening_pembayarans" value="{{Request::old('no_rekening_pembayarans')}}">
